...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CategoryPagesAdapter adapter = new CategoryPagesAdapter(this,getSupportFragmentManager());

        mViewPager.setAdapter(adapter);
        TabLayout table = (TabLayout)findViewById(R.id.sliding_tabs);
       ...
       /** family.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent family = new Intent(MainActivity.this, FamilyMembersActivty.class);
